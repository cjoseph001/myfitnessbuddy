    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 backdrop-blur-sm px-4">
      <div className="bg-white rounded-3xl w-full max-w-5xl h-[85vh] flex flex-col shadow-2xl ring-1 ring-gray-100">
        ...
        <div className="flex-1 overflow-y-auto px-6 pt-6 pb-3">
          <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-2xl px-3 py-2 mb-5 shadow-sm focus-within:ring-2 focus-within:ring-blue-300 transition">
            <Search className="w-5 h-7.5 text-gray-500" />
            <input
              type="text"
            ...
            {muscleTabs.map((muscle) => {
              ...
              return (
                <button
                  ...
                  className={`
          text-sm font-medium px-4 py-2 mr-2 relative transition-colors duration-200
          ${
            active
              ? "text-blue-600 after:absolute after:-bottom-0.5 after:left-0 after:w-full after:h-0.5 after:bg-blue-600"
        ...
        <div className="flex justify-end gap-3 p-5 border-t border-gray-100 bg-white sticky bottom-0">
          <button
            onClick={onCancel}
            className="px-6 py-2 bg-gray-100 hover:bg-gray-200 rounded-2xl text-gray-700 font-medium transition"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-medium transition"
          >
            Select
          </button>
        </div>
